...
# current - Print the information about the configuration file currently in use.
# validate - Validate that a configuration file is correct and can be used by the application.
# (DONE) use - Choose a configuration file to use for the application. Each time the application is run, the configuration file will be loaded.
# (DONE) remove - Delete a configuration file. This will remove the configuration file from the system.
